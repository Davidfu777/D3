...
let svg = d3.selectAll('svg#big-countries')
    .selectAll('rect')
    .data(countries)
    .enter()
    .append('rect')
    ...
    .style('fill', 'red')
let text = d3.selectAll('svg#big-countries')    
    .selectAll('text')
    .data(countries)
    .enter()
    .append('text')
...
let popScale = d3.scaleSqrt()
    .domain([0, 1500])    // population between 0 and 15000
    .range([0, 400])      // SVG positions between 0 and 400
    console.log(popScale(500))
